<?php
/**
 * ZF-Dropbox - Endpoint FileOpsCopy
 *
 * Copies a file or folder to a new location in your dropbox.
 *
 ...
 * @version    1.0
 * @see        https://www.dropbox.com/developers/core/docs#fileops-copy
 * @license    BSD
 */
        ...
        ZendX_Dropbox_Interfaces_Endpoint
{
     ...
     * @return ZendX_Dropbox_Endpoints_FileOpsCopy
     */
    public function setFromCopyRef ($reference)
    {
        $this->_fromcopyref = (string) $reference;
        return $this;
    }
    ...
    public function getData ()
    {
        $data = array(
                ...
                'from_copy_ref' => $this->_fromcopyref
        );
    ...
    {
        return array(
                'endpointurl' => 'https://api.dropbox.com/1/fileops/copy',
                'method' => 'post'
        );
    }
}